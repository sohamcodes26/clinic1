  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <section className="relative w-full h-[calc(100dvh-64px)] md:h-[calc(100dvh-120px)] bg-white flex flex-col justify-start md:justify-center overflow-hidden">
        ...
        <HeroFace3D />
        <div className="relative z-[5] w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 md:pt-0 pointer-events-none">
          <div className="max-w-2xl">
            {/* Branding - hidden on mobile since navbar already shows it */}
            ...
            <h1 className="text-2xl md:text-5xl font-serif font-bold text-foreground leading-tight mb-3 md:mb-4">
              We Provide <br />
              Overall Skincare Solutions
            </h1>
            <p className="text-base md:text-lg text-foreground/70 mb-4 md:mb-6 max-w-xl">
            ...
            <div className="md:hidden rounded-2xl overflow-hidden mb-4 shadow-lg">
              <img 
